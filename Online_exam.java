...
class OnlineTestBegin extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==0)
        {
            l.setText("Que1: Which one of the following is not a Java feature?");
        ...
        if(current==1)
        {
            l.setText("Que2: Which of these cannot be used for a variable name in Java?");
            jb[0].setText("Identifier and keyword");
            jb[1].setText("identifier");
            jb[2].setText("keyword");//
            jb[3].setText("none of this");
        }
        if(current==2)
        {
            l.setText("Que3:Which environment variable is used to set the java path?");
            jb[0].setText("MAVEN_Path");
            jb[1].setText("Java.PATH ");
            jb[2].setText("JAVA");
            jb[3].setText("JAVAHOME");//
        }
        if(current==3)
        {
            l.setText("Que4: Which of the following is a type of polymorphism in Java Programming?");
            jb[0].setText("Multiple polymorphism");
            jb[1].setText("Compile time polymorphism");//
            jb[2].setText("Multilevel polymorphism");
            jb[3].setText("Executon time polymorphism");
        }
        if(current==4)
        {
        ...
        if(current==5)
        {
            l.setText("Que6: Which one of the following is not an access modifier?");
        ...
        if(current==6)
        {
            l.setText("Que7:What is the numerical range of a char data type in Java?");
            jb[0].setText("0 to 256");
            jb[1].setText("-128 to 127");
            jb[2].setText("0 to 65535");//
            jb[3].setText("0 to 32767");
        }
        if(current==7)
        {
            l.setText("Que8: Which class provides system independent server side implementation?");
            jb[0].setText("Server");
            jb[1].setText("ServerReader");
            jb[2].setText("Socket");
            jb[3].setText("ServerSocket");//
        }
        if(current==8)
        {
